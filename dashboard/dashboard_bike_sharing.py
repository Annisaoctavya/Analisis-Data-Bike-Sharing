...
# Id Dicoding   : dicoding.com/users/annisaoctavya/                                     =
# ===============================================================
...
st.sidebar.markdown("**• Nama: Annisa Octavyanti Hakim**")
st.sidebar.markdown(
    "**• Email: [annisaoctavya@gmail.com](alkav.maulana@gmail.com)**")
st.sidebar.markdown(
    "**• Dicoding: [annisa octavyanti](https://www.dicoding.com/users/annisaoctavya/)**")
